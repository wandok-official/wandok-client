    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8 sm:p-12">
        ...
        <header className="mb-8">
          ...
          <p className="text-sm text-gray-500">최종 업데이트: 2026년 2월 10일</p>
        </header>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            <li>
              <strong className="text-gray-900">storage</strong>: 확장 프로그램의 활성화 상태를
              브라우저에 저장하여 새로고침 후에도 상태를 유지합니다.
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-3">
            완독이는 확장 프로그램의 활성화 상태(켜짐/꺼짐)만을 브라우저의 로컬 저장소
            (chrome.storage.local)에 저장합니다. 이 데이터는 외부 서버로 전송되지 않으며,
            확장 프로그램을 끄면 모든 시각적 효과가 즉시 제거됩니다.
          </p>
          <p className="text-gray-700">
            확장 프로그램을 제거하면 저장된 모든 데이터가 자동으로 삭제됩니다.
          </p>
        </section>
